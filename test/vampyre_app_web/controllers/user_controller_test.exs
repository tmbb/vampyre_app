defmodule VampyreAppWeb.UserControllerTest do
  use VampyreAppWeb.ConnCase

  alias VampyreApp.Accounts

  @create_attrs %{address: "some address", date_of_birth: ~D[2010-04-17], email: "some email", full_name: "some full_name", nickname: "some nickname", rank: 42}
